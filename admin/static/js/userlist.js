    ...
    methods: {
        ...
        loadDbShow: function loadDbShow(res) {
            ...
            for (var i = 0; i < tablelen; i++) {
                ...
                res.data.arr[i].showissystem = res.data.arr[i].issystem == 1 ? true : false;
                res.data.arr[i].showusername = res.data.arr[i].username;
                if (res.data.arr[i].showusername.length > 11) {
                    res.data.arr[i].showusername = res.data.arr[i].username.substring(0, 11) + "...";
                }
            }
        ...
        shipmenlistShow: function shipmenlistShow(index, row) {
            this.$router.push({ path: "shipmentlist", query: row });
        },
        ...
        roleName: function roleName(roles) {
            return this.$constants.GetUserRole(roles.toString());
        },
        sexName: function sexName(sexs) {
            if (sexs == 0) {
                return "女";
            } else if (sexs == 1) {
                return "男";
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" 表格")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("用户列表")])], 1)], 1), _vm._v(" "), _c('div', {
    staticStyle: {
      "margin-bottom": "10px"
    }
  }, [_c('el-row', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(scope) {
        return [_c('div', {
        ...
        }, [_vm._v("详情")]), _vm._v(" "), (scope.row.role > 1) ? _c('el-button', {
          attrs: {
            "size": "small",
            "type": "danger"
          },
          on: {
            "click": function($event) {
              _vm.toOffline(scope.$index, scope.row)
            }
          }
        }, [_vm._v("下线用户")]) : _vm._e(), _vm._v(" "), (scope.row.role == 2) ? _c('el-button', {
          attrs: {
            "size": "small",
            "type": "danger"
          },
          on: {
            "click": function($event) {
              _vm.shipmenlistShow(scope.$index, scope.row)
            }
          }
        }, [_vm._v("对货")]) : _vm._e()], 1)]
      }
