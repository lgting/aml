...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        onSubmit: function onSubmit() {
            ...
            if (this.form.rolename == null || this.form.rolename == null) {
                this.$message.error('角色名字不能为空');
                return;
            }

            var backmsg = { type: "addadminrole", rolename: this.form.rolename };
            ...
            this.$axios.post('php/admin/Route.php', __WEBPACK_IMPORTED_MODULE_0_qs___default.a.stringify(backmsg)).then((function (res) {
                ...
                if (res.data.error == 'ok') {
                    _this.$message('角色添加成功');
                    _this.$constants.SetAdmintPower(res.data.arr);
                } else if (res.data.error == '-100') {
                    _this.$message.error("角色名字不能为空");
                } else if (res.data.error == '-101') {
                    _this.$message.error("这个角色已经存在");
                } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" 表单")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("添加管理员角色")])], 1)], 1), _vm._v(" "), _c('div', {
