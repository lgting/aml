...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getData: function getData() {
            ...
            //              });
            var backmsg = { type: "offlinelist", page: self.cur_page - 1, userid: this.row.userid };
            ...
            this.$axios.post('php/admin/UserEdit.php', __WEBPACK_IMPORTED_MODULE_0_qs___default.a.stringify(backmsg)).then((function (res) {
                ...
                for (var i = 0; i < tablelen; i++) {
                    res.data.arr[i].showrole = _this.roleName(res.data.arr[i].role);
                    res.data.arr[i].showRegTime = _this.formatDateTime(res.data.arr[i].regTime * 1000);
                    res.data.arr[i].showsex = _this.sexName(res.data.arr[i].sex);
                }
        ...
        selectUser: function selectUser() {
            ...
            this.$axios.post('php/admin/UserEdit.php', __WEBPACK_IMPORTED_MODULE_0_qs___default.a.stringify(backmsg)).then((function (res) {
                //                  console.log('backmsg='+res.data.error);
                ...
                if (res.data.error != 'ok') {
                    ...
                    var tablelen = res.data.arr.length;
                    for (var i = 0; i < tablelen; i++) {
                        res.data.arr[i].showrole = _this2.roleName(res.data.arr[i].role);
                        res.data.arr[i].showRegTime = _this2.formatDateTime(res.data.arr[i].regTime * 1000);
                        res.data.arr[i].showsex = _this2.sexName(res.data.arr[i].sex);
                    }
                    self.tableData = res.data.arr;
                    self.pageMax = parseInt(res.data.pageMax); //;
                }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" 表格")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("用户下线列表")])], 1)], 1), _vm._v(" "), _c('el-table', {
    staticStyle: {
      "width": "100%"
    },
    attrs: {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(scope) {
        ...
        }, [_vm._v("编辑")]), _vm._v(" "), (_vm.currole > 1) ? _c('el-button', {
          attrs: {
            "size": "small",
            "type": "danger"
          },
