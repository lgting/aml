...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        var rlist = this.$constants.GetAdmintPower();

        for (var i = 0; i < rlist.length; i++) {
            this.options.push({ value: rlist[i].id, label: rlist[i].rolename });
        }
    },
    ...
    methods: {
        ...
        onSubmit: function onSubmit() {
            ...
            if (this.form.username == null || this.form.username == null) {
                this.$message.error('用户名不能够为空');
                return;
            }

            var backmsg = { type: "editadminrole", userid: this.form.id, role: this.form.role };
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" 表单")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v(" 编辑用户角色 ")])], 1)], 1), _vm._v(" "), _c('div', {
