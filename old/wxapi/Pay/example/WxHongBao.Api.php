...
class WxHongBao
{
	// 企业转账请求地址https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers
	const TRANSFERS_URL = 'https://api.mch.weixin.qq.com/mmpaymkttransfers/sendredpack';
	...
	public function transfers($parameters){
		...
		if (! isset($parameters['mch_billno'])) {
			$parameters['mch_billno'] = $this->getPartnerTradeNo();
		}
		...
		$this->error = (string) $resultObj->err_code;
		return false;
	}
	...
	public function getPartnerTradeNo()
	{
		...
		//$this->_lastPartnerTradeNo = date('YmdHis').mt_rand(10000000,99999999);
		
		//echo 'ddh='.$this->_lastPartnerTradeNo.'<br>';
	...
	{
		// return true;		
		if ($this->_parameters["wxappid"] == null ||
